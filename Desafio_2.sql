...
('1', 'Frida Corona', '8155226699', 'Gerente General', '15,000'),
('2', 'Alberto Garza', '8155448877', 'Dueño', '20,000'),
('3', 'Alma Ayala', '8146948877', 'Jefe de cocina', '12,000'),
('4', 'Abril Ayala', '8155447877', 'Cocinera', '8,000'),
('5', 'Rolando Guerrero', '8155478877', 'Mesero', '5,000'),
('6', 'Hugo Alfaro', '8196127877', 'Mesero', '5,000');

INSERT INTO proveedor (id_proveedor, nombre_proveedor, contacto_proveedor, tipo_de_pago_proveedor, producto_proveedor) VALUES
(1, 'Los pollos hermanos', '7894561230', 'efectivo', 'Muslos de pollo'),
(2, 'Verdura del Campo', '1236547899', 'efectivo', 'verduras'),
(3, 'Desechable Lopes', '6543219877', 'credito', 'insumos'),
(4, 'Aderezos buffalo', '7893214560', 'efectivo', 'Salsas y condiemntos'),
(5, 'coca-cola', '5487213698', 'credito', 'refrescos'),
(6, 'Cerveceria Cuauhtemoc ', '1236547899', 'credito', 'cerveza'),
(7, 'Materias primas Rodriguez', '2486159723', 'efectivo', 'Materias primas');
...
(4, '4,521.70', 'YUJN890514ETF'),
(5, '5,632.36', 'CVGD0010155HE');
